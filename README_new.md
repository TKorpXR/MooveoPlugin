...
1. Ouvrez Unity Package Manager
2. Cliquez sur `+` → `Add package from git URL`
3. Entrez : `https://github.com/bl0bli/mooveo.git`

### Via manifest.json
```json
{
  "dependencies": {
    "com.bl0bli.mooveo": "https://github.com/bl0bli/mooveo.git"
  }
}
```
...
- GitHub : [@bl0bli](https://github.com/bl0bli)
...
- 📧 Email : bosseenzo6@gmail.com
- 🐛 Issues : [GitHub Issues](https://github.com/bl0bli/mooveo/issues)
